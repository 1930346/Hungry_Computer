...
class Department(models.Model):
    ...
    name = models.CharField(max_length=100, choices=departments_list, default = "RH")
    description = models.TextField(max_length=255)
...
class Order_product(models.Model):
    ...
    authorized_by = models.ForeignKey(Employee,on_delete=models.CASCADE)
    # authorized_id = models.IntegerField(default = 0, primary_key=True)
    pickup_date = models.DateTimeField()


class Assembly_order(models.Model):
    attendant = models.ForeignKey(Employee, on_delete=models.CASCADE) #ForeignKey with Employee_id
